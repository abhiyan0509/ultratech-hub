...
from agents import crawler_agent, financial_agent, ma_agent, competitor_agent, outlook_agent, macro_agent, quant_agent, history_agent
...
def main():
    ...
    agents = [
        ...
        ("history", lambda: history_agent.run()),
    ]
